...
namespace AnimalAidPlatform.API.Migrations
{
    ...
    [Migration("20241103175156_ReportModell")]
    partial class ReportModell
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnimalAidPlatform.API.Models.Category", b =>
                {
                    ...
                    b.Property<string>("AssestIconHref")
                        .IsRequired()
            ...
            modelBuilder.Entity("AnimalAidPlatform.API.Models.FeedPostLike", b =>
                {
            ...
            modelBuilder.Entity("AnimalAidPlatform.API.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AnimalAidPlatform.API.Models.NotificationSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AnimalAidPlatform.API.Models.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CategoryNotificationSettings", b =>
                {
                    ...
                    b.HasKey("CategoriesId", "NotificationSettingsId");
            ...
            modelBuilder.Entity("AnimalAidPlatform.API.Models.NotificationSettings", b =>
                {
                    b.HasOne("AnimalAidPlatform.Models.ApplicationUser", "User")
                        ...
                        .HasForeignKey("AnimalAidPlatform.API.Models.NotificationSettings", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AnimalAidPlatform.API.Models.Report", b =>
                {
                    ...
                    b.HasOne("AnimalAidPlatform.Models.ApplicationUser", "Reporter")
                        .WithMany()
            ...
            modelBuilder.Entity("CategoryNotificationSettings", b =>
                {
                    b.HasOne("AnimalAidPlatform.API.Models.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AnimalAidPlatform.API.Models.NotificationSettings", null)
                        .WithMany()
